...
# This script lives at: <repo_root>/research/experiments/maddpg/generate_trajectory_data.py
repo_root = os.path.dirname(os.path.dirname(os.path.dirname(os.path.dirname(os.path.abspath(__file__)))))
sys.path.append(repo_root)

from nexus_core.mas.environment import SkyNetEnv
from research.experiments.maddpg.emergence_metrics import calculate_cluster_entropy
